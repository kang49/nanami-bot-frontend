        ...
        <div
            ...
            <div class="w-full h-full flex items-center">
                <div class="px-[20px] w-full h-[80%]">
                    ...
                    <div class="w-full h-max mt-[30px] p-[20px] rounded-[20px] bg-black/40 overflow-hidden transition-all duration-[1000ms] lg:w-[35%]" :class="{ 'translate-y-[100vw] opacity-0': !isOnMounted, 'translate-y-[0] opacity-100': isOnMounted }">
